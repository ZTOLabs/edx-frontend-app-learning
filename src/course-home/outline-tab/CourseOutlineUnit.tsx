  ...
  return (
    <button
      ...
      className={classNames(
        'tw-py-[10px] tw-pl-6 tw-pr-3 tw-flex tw-gap-2 tw-border-0 tw-bg-transparent tw-w-full tw-items-center tw-rounded-[8px] tw-text-gray-700',
        {
    ...
    >
      ...
      <span className="tw-text-xs tw-font-medium tw-text-start">
        {title}
      </span>
    </button>
  );
